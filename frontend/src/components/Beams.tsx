// @ts-nocheck
import { forwardRef, useImperativeHandle, useEffect, useRef, useMemo, type FC, type ReactNode, type CSSProperties } from 'react';
...
const Beams: FC<BeamsProps> = ({
  ...
  return (
    <div className={`beams-container ${className}`} style={style}>
